...
namespace :cloth_prada_mytheresa do
	...
	task prepare: :environment do
		...
		base_url = "http://www.mytheresa.com/en-us/designers/prada/clothing.html?p="
		number_of_pages = 3
		...
		File.open("#{Rails.root}/lib/tasks/fashion/cloth/prada/mytheresa/cloth.csv", "wb") do |file|
