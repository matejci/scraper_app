...
namespace :cloth_gucci_netaporter do
	...
	task prepare: :environment do
		...
		url_arr = ["https://www.net-a-porter.com/us/en/Shop/Designers/Gucci/Clothing?image_view=product&pn=", "&npp=60&dScroll=0"]
		...
		File.open("#{Rails.root}/lib/tasks/fashion/cloth/gucci/netaporter/cloth.csv", "wb") do |file|
