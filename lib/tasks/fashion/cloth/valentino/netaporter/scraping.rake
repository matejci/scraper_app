...
namespace :cloth_valentino_netaporter do

	desc "Scrap Valentino cloth data"
	task scrap: :environment do

		file_content_array = []

		File.foreach("#{Rails.root}/lib/tasks/fashion/cloth/valentino/netaporter/cloth.csv") do |line|
