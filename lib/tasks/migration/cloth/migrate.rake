namespace :cloth_migrate do

	desc "Migrate cloth data"
	task start: :environment do

		arr = ["DolceGabbana", "Fendi", "Jimmy Choo", "Gucci","Prada", "TomFord"]

		items = Item.where("item_type = ? AND manufacturer IN (?)", "cloth", arr)
