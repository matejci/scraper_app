...
namespace :bags_dg_netaporter do

	desc "Prepare DolceGabbana bags data"
	task prepare: :environment do

		host = "https://www.net-a-porter.com"
		url = "https://www.net-a-porter.com/us/en/Shop/Designers/Dolce_and_Gabbana/Bags?pn=1&npp=60&image_view=product&dScroll=0"
		...
		File.open("#{Rails.root}/lib/tasks/fashion/bags/dolcegabbana/netaporter/bags.csv", "wb") do |file|
