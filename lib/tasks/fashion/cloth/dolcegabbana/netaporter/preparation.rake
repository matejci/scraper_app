...
namespace :cloth_dg_netaporter do
	...
	task prepare: :environment do
		...
		url_arr = ["https://www.net-a-porter.com/us/en/Shop/Designers/Dolce_and_Gabbana/Clothing?image_view=product&pn=", "&npp=60&dScroll=0"]
		...
		File.open("#{Rails.root}/lib/tasks/fashion/cloth/dolcegabbana/netaporter/cloth.csv", "wb") do |file|
