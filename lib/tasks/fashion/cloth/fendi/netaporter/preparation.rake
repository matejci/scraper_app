...
namespace :cloth_fendi_netaporter do
	...
	task prepare: :environment do
		...
		url = "https://www.net-a-porter.com/us/en/Shop/Designers/Fendi/Clothing?pn=1&npp=60&image_view=product&dScroll=0"
		...
		File.open("#{Rails.root}/lib/tasks/fashion/cloth/fendi/netaporter/cloth.csv", "wb") do |file|
