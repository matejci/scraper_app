...
namespace :cloth_laperla_netaporter do
	...
	desc "Prepare La Perla cloth data"
	task prepare: :environment do

		host = "https://www.net-a-porter.com"
		url_arr = ["https://www.net-a-porter.com/us/en/Shop/Designers/La_Perla/Lingerie?pn=", "&npp=60&image_view=product&dScroll=0"]
		...
		url = "https://www.net-a-porter.com/us/en/Shop/Designers/La_Perla/Clothing?pn=1&npp=60&image_view=product&dScroll=0"
		...
		File.open("#{Rails.root}/lib/tasks/fashion/cloth/laperla/netaporter/cloth.csv", "wb") do |file|
