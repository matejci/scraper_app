...
namespace :shoes_dg_netaporter do

	desc "Prepare DolceGabbana shoes data"
	task prepare: :environment do

		host = "https://www.net-a-porter.com"
		url = "https://www.net-a-porter.com/us/en/Shop/Designers/Dolce_and_Gabbana/Shoes?image_view=product&pn=1&npp=60&dScroll=0"
		...
		File.open("#{Rails.root}/lib/tasks/fashion/shoes/dolcegabbana/netaporter/shoes.csv", "wb") do |file|
