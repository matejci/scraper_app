...
namespace :cloth_gucci_mytheresa do
	...
	task prepare: :environment do
		...
		base_url = "http://www.mytheresa.com/en-us/designers/gucci/clothing.html?p="
		number_of_pages = 4
		...
		File.open("#{Rails.root}/lib/tasks/fashion/cloth/gucci/mytheresa/cloth.csv", "wb") do |file|
