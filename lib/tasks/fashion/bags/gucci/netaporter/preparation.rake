...
namespace :bags_gucci_netaporter do
	...
	task prepare: :environment do
		...
		url = "https://www.net-a-porter.com/us/en/Shop/Designers/Gucci/Bags?pn=1&npp=60&image_view=product&dScroll=0"
		...
		File.open("#{Rails.root}/lib/tasks/fashion/bags/gucci/netaporter/bags.csv", "wb") do |file|
