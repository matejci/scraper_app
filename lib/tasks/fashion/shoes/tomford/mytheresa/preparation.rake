...
namespace :shoes_tomford_mytheresa do
	...
	task prepare: :environment do
		...
		base_url = "http://www.mytheresa.com/en-us/designers/tom-ford/shoes.html?p="
		number_of_pages = 2
		...
		File.open("#{Rails.root}/lib/tasks/fashion/shoes/tomford/mytheresa/shoes.csv", "wb") do |file|
