...
namespace :bags_tomford_mytheresa do

	desc "Prepare Tom Ford bags data"
	task prepare: :environment do

		base_url = "http://www.mytheresa.com/en-us/designers/tom-ford/bags.html?p="
		...
		File.open("#{Rails.root}/lib/tasks/fashion/bags/tomford/mytheresa/bags.csv", "wb") do |file|
