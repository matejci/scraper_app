...
namespace :shoes_gucci_netaporter do
	...
	task prepare: :environment do
		...
		url_arr = ["https://www.net-a-porter.com/us/en/Shop/Designers/Gucci/Shoes?pn=", "&npp=60&image_view=product&dScroll=0"]
		...
		File.open("#{Rails.root}/lib/tasks/fashion/shoes/gucci/netaporter/shoes.csv", "wb") do |file|
