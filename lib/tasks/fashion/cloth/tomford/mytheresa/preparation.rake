...
namespace :cloth_tomford_mytheresa do
	...
	desc "Prepare Tom Ford cloth data"
	task prepare: :environment do

		base_url = "http://www.mytheresa.com/en-us/designers/tom-ford/clothing.html?p="
		...
		File.open("#{Rails.root}/lib/tasks/fashion/cloth/tomford/mytheresa/cloth.csv", "wb") do |file|
