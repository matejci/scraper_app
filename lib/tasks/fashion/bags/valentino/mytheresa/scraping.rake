...
namespace :bags_valentino_mytheresa do

	desc "Scrap Valentino bags data"
	task scrap: :environment do

		file_content_array = []

		File.foreach("#{Rails.root}/lib/tasks/fashion/bags/valentino/mytheresa/bags.csv") do |line|
