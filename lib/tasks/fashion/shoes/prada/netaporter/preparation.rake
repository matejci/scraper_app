...
namespace :shoes_prada_netaporter do
	...
	task prepare: :environment do
		...
		url = "https://www.net-a-porter.com/us/en/Shop/Designers/Prada/Shoes?pn=1&npp=60&image_view=product&dScroll=0"
		...
		File.open("#{Rails.root}/lib/tasks/fashion/shoes/prada/netaporter/shoes.csv", "wb") do |file|
