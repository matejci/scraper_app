...
namespace :bags_gucci_mytheresa do

	desc "Prepare Gucci bags data"
	task prepare: :environment do

		base_url = "http://www.mytheresa.com/en-us/designers/gucci/bags.html?p="
		number_of_pages = 2
		...
		File.open("#{Rails.root}/lib/tasks/fashion/bags/gucci/mytheresa/bags.csv", "wb") do |file|
