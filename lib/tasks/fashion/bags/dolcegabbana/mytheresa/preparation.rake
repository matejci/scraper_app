...
namespace :bags_dg_mytheresa do
	...
	task prepare: :environment do
		...
		base_url = "http://www.mytheresa.com/en-us/designers/dolce-gabbana/bags.html?p="
		number_of_pages = 3
		...
		File.open("#{Rails.root}/lib/tasks/fashion/bags/dolcegabbana/mytheresa/bags.csv", "wb") do |file|
