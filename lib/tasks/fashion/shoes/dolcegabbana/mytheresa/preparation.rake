...
namespace :shoes_dg_mytheresa do
	...
	task prepare: :environment do
		...
		base_url = "http://www.mytheresa.com/en-us/designers/dolce-gabbana/shoes.html?p="
		number_of_pages = 3
		...
		File.open("#{Rails.root}/lib/tasks/fashion/shoes/dolcegabbana/mytheresa/shoes.csv", "wb") do |file|
